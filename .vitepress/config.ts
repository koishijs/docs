  ...
  defineConfig({
    ...
    themeConfig: {
      ...
      sidebar: {
        "/manual/": [
          {
            items: [makeLink("介绍", "/manual/introduction.md")],
          },
          {
            items: [
          ...
          {
            text: "配方",
            items: [makeLink("服务器部署", "/manual/recipe/server.md")],
          },
        ],

        "/guide/": [
          {
            items: [makeLink("总览", "/guide/")],
          },
          {
            text: "交互基础",
            items: [
          ...
          {
            text: "测试工具",
            items: [makeLink("单元测试", "/guide/testing/index.md")],
            // }, {
            //   text: '深入底层',
            //   items: [
        ...
        "/api/": [
          ...
          {
            text: "测试工具",
            items: [makeLink("模拟环境 (Mock)", "/api/testing/")],
          },
        ],
    ...
    vite: {
      plugins: [
        SearchPlugin({
          ...
          readKey: process.env.VITE_MEILISEARCH_READ_KEY,
          writeKey: process.env.VITE_MEILISEARCH_WRITE_KEY,
          indexName: process.env.VITE_MEILISEARCH_INDEX ?? 'search-koishi-chat',
        }),
      ],
    },
  });
