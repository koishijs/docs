    ...
    sidebar: {
      '/en-US/manual/': [
        ...
        makeLink('', '/en-US/manual/starter', () => [
          ...
          makeLink('Install for Windows', '/windows.md'),
          makeLink('Install for macOS', '/macos.md'),
          makeLink('Install for Linux', '/linux.md'),
          makeLink('Install for Android', '/android.md'),
          makeLink('在容器中使用', '/docker.md'),
          makeLink('Create Template Project', '/boilerplate.md'),
          makeLink('Use as Dependency', '/direct.md'),
        ]),
        makeLink('Console', '/en-US/manual/console', () => [
          makeLink('About Koishi Console', '/index.md'),
          makeLink('Install and Configure Plugins', '/market.md'),
          makeLink('Chat in Sandbox', '/sandbox.md'),
          makeLink('Collaborate with Chat Platforms', '/adapter.md'),
        ]),
