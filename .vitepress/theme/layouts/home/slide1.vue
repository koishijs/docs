  ...
  <div class="screen screen-cover">
    ...
    <svg aria-hidden="true" focusable="false" role="img" viewBox="0 0 320 512">
      <g>
        ...
        <path fill="var(--vp-c-brand-1)" d="M313 182.57 290.21 160a23.94 23.94.0 00-33.85.0L103.47 312.61 143 352l.06.06a24 24 0 0033.93-.16L313 216.36l.18-.17a23.78 23.78.0 00-.18-33.62z"></path>
      </g>
    </svg>
  </div>
</template>
