...
![database](/console/database_light.webp) {.light-only}

![database](/console/database_dark.webp) {.dark-only}
...
![database_user](/console/database_user_light.webp) {.light-only}

![database_user](/console/database_user_dark.webp) {.dark-only}