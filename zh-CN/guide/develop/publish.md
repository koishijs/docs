...
- **service:** 插件的服务相关信息，具体包含下列属性：
  - **required:** 插件必需的服务，在缺少这些服务的情况下插件无法运行。应该是一个服务名构成的数组
  - **optional:** 插件可选的服务，即使没有的情况下插件也可以运行，但体验会稍差一些。应该是一个服务名构成的数组
  - **implements:** 插件实现的服务，你的插件可以为其他插件提供的服务。应该是一个服务名构成的数组
